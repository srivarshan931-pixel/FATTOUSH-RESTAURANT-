      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div>
          <button
            ...
            className="px-6 py-2.5 bg-transparent border border-gold-warm text-gold-warm text-xs tracking-[0.2em] font-sans font-bold hover:bg-gold-warm hover:text-forest-dark transition-all duration-500 ease-out uppercase rounded-sm shadow-md cursor-pointer"
          >
            Reserve Table
          </button>
        </div>
