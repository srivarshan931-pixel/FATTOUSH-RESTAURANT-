...
export async function submitReservation(formData: FormData) {
  try {
    ...
    // Use environment variable if set, otherwise fallback to the placeholder
    const googleSheetUrl = process.env.GOOGLE_SHEET_SCRIPT_URL || "YOUR_GOOGLE_APPS_SCRIPT_WEB_APP_URL_HERE";
